...
if (isset($_GET['delete']) && is_numeric($_GET['delete'])) {
    ...
    if ($product) {
        ...
        if (file_exists($upload_dir . $product['product_image1'])) unlink($upload_dir . $product['product_image1']);
        if (file_exists($upload_dir . $product['product_image2'])) unlink($upload_dir . $product['product_image2']);
        if (file_exists($upload_dir . $product['product_image3'])) unlink($upload_dir . $product['product_image3']);
    }
                            ...
                            <table id="productsTable" class="table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="../img/Products/<?php echo htmlspecialchars($product['product_image1']); ?>" 
